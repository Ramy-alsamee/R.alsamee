...
## المزايا والتحسينات الأمنية المتقدمة

| الميزة الأمنية | الوصف التقني |
|---|---|
| **التوقيع الرقمي (HMAC)** | التحقق من صحة ومصدر الرسائل الواردة لمنع أي تلاعب أو حقن أوامر غير مصرح بها. |
| **حماية ضد إعادة التشغيل (Anti-Replay)** | رفض أي رسالة تنقضي مدة صلاحيتها (أكثر من 5 دقائق) أو تتكرر بصمة معرّفها. |
| **الموافقة اليدوية المحلية** | إبقاء القرار النهائي حصرياً للمستخدم على الجهاز؛ لا يُنفذ أي أمر دون كتابة `y`. |
